...
def test_signup_for_activity_fails_when_already_signed_up(client: TestClient):
    # Arrange
    activity_name = "Chess Club"
...
def test_unregister_from_activity_returns_404_for_missing_activity(client: TestClient):
    # Arrange
    activity_name = "Nonexistent Club"
    email = "student@mergington.edu"
    url = f"/activities/{activity_name}/participants"
...
def test_unregister_from_activity_returns_404_when_student_not_signed_up(client: TestClient):
    # Arrange
    activity_name = "Chess Club"
