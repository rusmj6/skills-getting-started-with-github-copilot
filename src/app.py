...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive team practices and games",
    ...
    "Drama Club": {
        "description": "Acting workshops and theatre production rehearsals",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["chloe@mergington.edu", "noah@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments and science project collaborations",
